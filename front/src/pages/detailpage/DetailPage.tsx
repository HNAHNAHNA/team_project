    ...
    <Container>
      <div className="w-full h-auto overflow-hidden rounded-xl relative">
        ...
        <div className="mt-5 p-6 bg-white rounded-2xl ">
          <p>
            このホテルは東京駅から徒歩わずか5分の場所に位置しており、快適でスタイリッシュな客室をご用意しております。
            全室には高品質なベッドと最新の空調設備を完備し、ビジネスや観光でのご利用に最適です。

            朝食は地元の食材を使用した和洋ビュッフェスタイルで、毎朝新鮮なメニューをお楽しみいただけます。
            館内には天然温泉やコインランドリーもあり、長期滞在にも便利です。

            無料Wi-Fi、全室禁煙、チェックインは15時から、チェックアウトは10時まで。
